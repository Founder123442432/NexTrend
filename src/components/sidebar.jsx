...
export default function Sidebar() {
  ...
  return (
    <nav
      className={`bg-white ${
        isopen ? "sm:left-0 " : "sm:left-[-250px]"
      } lg:left-0 lg:relative transition-all sm:fixed sm:top-0 z-50 lg:block  shadow-xl min-h-screen min-w-[250px] py-6 font-[sans-serif]  `}
    >
      <button
        onClick={() => setisopen((isopen) => !isopen)}
        className="lg:hidden  right-[-50px] absolute  top-[50%] cursor-pointer duration-200 hover:scale-125 active:scale-100"
        title="Go Back"
      >
        <svg
          ...
          height="50px"
          viewBox="0 0 24 24"
          className="stroke-green-500 bg-black"
        >
          <path
      ...
      <div className="relative flex flex-col h-full">
        ...
        <ul className="space-y-3 my-8 flex-1">
              ...
              <span
                className={`text-sm flex items-center  px-8 py-4 transition-all ${
                  loc == "/admin/Dashboard"
                    ...
                    : "hover:text-[#007bff] hover:border-r-[5px] border-[#077bff] hover:bg-gray-100"
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <span className="text-black text-sm flex items-center hover:text-[#007bff] hover:border-r-[5px] border-[#077bff] hover:bg-gray-100 px-8 py-4 transition-all">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                stroke="currentColor"
